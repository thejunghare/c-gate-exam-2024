...
int main(void) {
  ...
  /*
  for exists becuase folks do this counter based loopig ever time and foor loop is designed   to make this easy
         1     2    3
  for (expr; expr; expr){
    repetitive_code(); 
  }
  ...
  */
  ...
  /*
    ...
    contiune -> say I am done with current irratation loop start the next one
  */
